...
The software-engineering vocabulary that makes AI systems deployable. Mostly **→ Engineering Core**, with AI-specific applications repeated throughout Modules 0–6.
