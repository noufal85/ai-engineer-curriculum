...
The vocabulary for getting a program running on your computer. Assumed background for the curriculum, with project and deployment applications in [Engineering Core](engineering-core.md) and [M6](../curriculum/06-production-systems.md).
